...
if [[ -z "$version_content" ]]; then
  echo "<h2>PropAi Sync $VERSION</h2>"
  echo "<p>Latest PropAi Sync update.</p>"
  echo "<p><a href=\"https://github.com/propai/propai/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
