...
# Output:
# - dist/PropAiSync.app
# - dist/propai-<version>.zip
# - dist/propai-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.propai.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/PropAiSync.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/propai-$VERSION.zip"
DMG="$ROOT_DIR/dist/propai-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/propai-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/propai-$VERSION.dSYM.zip"
