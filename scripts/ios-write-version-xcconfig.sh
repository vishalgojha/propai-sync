...
- PROPAI_GATEWAY_VERSION = exact package.json version
- PROPAI_MARKETING_VERSION = short iOS/App Store version
- PROPAI_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
PROPAI_GATEWAY_VERSION = ${PACKAGE_VERSION}
PROPAI_MARKETING_VERSION = ${MARKETING_VERSION}
PROPAI_BUILD_VERSION = ${BUILD_NUMBER}
EOF
