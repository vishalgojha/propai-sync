...
- Keep product names in English: PropAi Sync, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the PropAi Sync Gateway, use “Gateway 网关”.
