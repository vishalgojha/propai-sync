...
- **GitHub:** https://github.com/vishalgojha/propai-sync
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/vishalgojha/propai-sync/discussions) or ask in Discord first
...
Check the [GitHub Issues](https://github.com/vishalgojha/propai-sync/issues) for "good first issue" labels!
...
- **Core CLI and gateway** — [vishalgojha/propai-sync](https://github.com/vishalgojha/propai-sync)
- **macOS desktop app** — [vishalgojha/propai-sync](https://github.com/vishalgojha/propai-sync) (apps/macos)
- **iOS app** — [vishalgojha/propai-sync](https://github.com/vishalgojha/propai-sync) (apps/ios)
- **Android app** — [vishalgojha/propai-sync](https://github.com/vishalgojha/propai-sync) (apps/android)
