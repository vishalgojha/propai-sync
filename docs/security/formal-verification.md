...
summary: Machine-checked security models for propai’s highest-risk paths.
read_when:
...
This page tracks propai’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that propai enforces its
...
**What this is not (yet):** a proof that “propai is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/propai-formal-models](https://github.com/vignesh07/propai-formal-models).
...
```bash
git clone https://github.com/vignesh07/propai-formal-models
cd propai-formal-models
