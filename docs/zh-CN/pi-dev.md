...
本指南总结了在 propai 中开发 Pi 集成的合理工作流程。
...
状态存储在 propai 状态目录下。默认为 `~/.propai`。如果设置了 `PROPAI_STATE_DIR`，则使用该目录。
...
- https://docs.propai.ai/testing
- https://docs.propai.ai/start/getting-started
