---
summary: "Synology Chat webhook setup and propai config"
read_when:
  - Setting up Synology Chat with propai
...
```bash
propai plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your propai gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in propai.
...
- Pairing approvals work with:
  - `propai pairing list synology-chat`
  - `propai pairing approve synology-chat <CODE>`
...
```bash
propai message send --channel synology-chat --target 123456 --text "Hello from propai"
propai message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
