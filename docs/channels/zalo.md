...
- Install via CLI: `propai plugins install @propai/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `propai plugins install ./extensions/zalo`
   - From npm (if published): `propai plugins install @propai/zalo`
...
- Approve via:
  - `propai pairing list zalo`
  - `propai pairing approve zalo <CODE>`
...
- Example: `propai message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `propai channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `propai logs --follow`
