...
read_when:
  ...
  - Reviewing propai security posture
title: "Pairing"
---

# Pairing

“Pairing” is propai’s explicit **owner approval** step.
...
Stored under `~/.propai/credentials/`:
...
3. On your phone, open the propai iOS app → Settings → Gateway.
