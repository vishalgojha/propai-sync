---
summary: "First-run onboarding flow for propai (macOS app)"
read_when:
...
- By default, propai is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give propai">
...
<Step title="CLI">
  ...
  The app can install the global `propai` CLI via npm/pnpm so terminal
