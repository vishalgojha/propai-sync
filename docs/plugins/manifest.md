...
read_when:
  - You are building a propai plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (propai.plugin.json)

Every plugin **must** ship a `propai.plugin.json` file in the **plugin root**.
propai uses this manifest to validate configuration **without executing plugin
