---
summary: "Use Qianfan's unified API to access many models in propai"
read_when:
...
3. propai installed on your system
...
4. Copy the API key for use with propai

## CLI setup

```bash
propai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [propai Configuration](/gateway/configuration)
