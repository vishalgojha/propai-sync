---
summary: "Use Synthetic's Anthropic-compatible API in propai"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. propai registers it as the
...
Note: propai's Anthropic client appends `/v1` to the base URL, so use
