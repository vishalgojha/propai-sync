...
describe("profile name validation", () => {
  it.each(["PropAi Sync", "work", "my-profile", "test123", "a", "a-b-c-1-2-3", "1test"])(
...
describe("port collision prevention", () => {
  it("raw config vs resolved config - shows the data source difference", () => {
    ...
    // But resolved config has implicit PropAi Sync at 18800
  ...
  it("create-profile must use resolved config to avoid port collision", () => {
    ...
    // Resolved config: includes implicit PropAi Sync at 18800
    const resolved = resolveBrowserConfig(
