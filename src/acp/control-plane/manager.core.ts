...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: PropAiSyncConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: PropAiSyncConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: PropAiSyncConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: PropAiSyncConfig }): Promise<void> {
