...
export function isAcpEnabledByPolicy(cfg: PropAiSyncConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: PropAiSyncConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: PropAiSyncConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: PropAiSyncConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: PropAiSyncConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: PropAiSyncConfig, agentId: string): boolean {
