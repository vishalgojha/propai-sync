...
export function listBindings(cfg: PropAiSyncConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: PropAiSyncConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PropAiSyncConfig) {
