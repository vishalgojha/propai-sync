...
describe("registerSlackInteractionEvents", () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "PropAi Sync:verify" }],
            },
          ],
        },
      },
  ...
  it("drops modal lifecycle payloads when mismatch guard triggers", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "PropAi Sync:deploy_form",
  ...
  it("falls back to container channel and message timestamps", async () => {
    ...
    await handler!({
      ...
      action: {
        type: "button",
        action_id: "PropAi Sync:container",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "PropAi Sync:multi" }],
            },
          ],
        },
      },
  ...
  it("renders date/time/datetime picker selections in confirmation rows", async () => {
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "PropAi Sync:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "PropAi Sync:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "PropAi Sync:datetime" }],
            },
          ],
        },
      },
    ...
    await handler!({
      ...
      action: {
        type: "datetimepicker",
        action_id: "PropAi Sync:datetime",
        block_id: "datetime_block",
  ...
  it("captures workflow button trigger metadata", async () => {
    ...
    await handler!({
      ...
      action: {
        ...
        action_id: "PropAi Sync:workflow",
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expect(payload).toMatchObject({
      ...
      actionId: "view:PropAi Sync:deploy_form",
      callbackId: "PropAi Sync:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V400",
          callback_id: "PropAi Sync:routing_form",
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@propai.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.propai.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expect(payload.inputs).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          inputKind: "email",
          inputEmail: "team@propai.ai",
        }),
        expect.objectContaining({
          actionId: "url_input",
          inputKind: "url",
          inputUrl: "https://docs.propai.ai/",
        }),
        expect.objectContaining({
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "PropAi Sync:long_richtext",
  ...
  it("caps oversized interaction payloads with compact summaries", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V915",
          callback_id: "PropAi Sync:oversize",
          private_metadata: JSON.stringify({
            channelId: "D915",
            channelType: "im",
            userId: "U915",
