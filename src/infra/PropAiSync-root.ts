...
const CORE_PACKAGE_NAMES = new Set(["PropAi Sync"]);
...
export async function resolvePropAiSyncPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolvePropAiSyncPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
