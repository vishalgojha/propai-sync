...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.propai.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", PROPAI_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.propai.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when PROPAI_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.propai.gateway.plist",
    },
    {
      name: "uses profile-specific label when PROPAI_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", PROPAI_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.propai.jbphoenix.plist",
    },
    {
      name: "prefers PROPAI_LAUNCHD_LABEL over PROPAI_PROFILE",
      env: {
        HOME: "/Users/test",
        PROPAI_PROFILE: "jbphoenix",
        PROPAI_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from PROPAI_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        PROPAI_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty PROPAI_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        PROPAI_PROFILE: "myprofile",
        PROPAI_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.propai.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
