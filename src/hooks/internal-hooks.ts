/**
 * Hook system for PropAi Sync agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __PROPAI_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__PROPAI_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
