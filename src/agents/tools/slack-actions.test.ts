...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): PropAiSyncConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: PropAiSyncConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: PropAiSyncConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
