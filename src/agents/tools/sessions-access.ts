...
export function resolveSessionToolsVisibility(cfg: PropAiSyncConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: PropAiSyncConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: PropAiSyncConfig): AgentToAgentPolicy {
