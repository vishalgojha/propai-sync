...
const CLEANUP_STATE_KEY = Symbol.for("PropAiSync.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("PropAiSync.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("PropAiSync.sessionWriteLockWatchdogState");
