...
async function resolveContext(config: PropAiSyncConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): PropAiSyncConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
