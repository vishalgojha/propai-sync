...
function resolveWatchPaths(workspaceDir: string, config?: PropAiSyncConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: PropAiSyncConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PropAiSyncConfig }) {
