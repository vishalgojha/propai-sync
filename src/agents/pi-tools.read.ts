...
type PropAiSyncReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: PropAiSyncReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createPropAiSyncReadTool(base, {
...
export function createPropAiSyncReadTool(
  base: AnyAgentTool,
  options?: PropAiSyncReadToolOptions,
): AnyAgentTool {
