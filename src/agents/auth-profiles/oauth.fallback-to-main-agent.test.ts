...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolvePropAiSyncAgentDir() returns mainAgentDir
    process.env.propai_STATE_DIR = tmpDir;
    process.env.propai_AGENT_DIR = mainAgentDir;
