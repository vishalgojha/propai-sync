...
export const DEFAULT_SANDBOX_IMAGE = "propai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "propai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "propai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "propai-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "propai-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "propai-sandbox-browser";
