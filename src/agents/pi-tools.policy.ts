...
export function resolveSubagentToolPolicy(cfg?: PropAiSyncConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: PropAiSyncConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: PropAiSyncConfig["tools"];
