...
const EMPTY_CFG = {} as PropAiSyncConfig;
...
async function applySubagentModelPatch(cfg: PropAiSyncConfig) {
...
function createAllowlistedAnthropicModelCfg(): PropAiSyncConfig {
  return {
    agents: {
      defaults: {
