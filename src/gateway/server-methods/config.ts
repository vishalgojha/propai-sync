...
import type { ConfigValidationIssue, PropAiSyncConfig } from "../../config/types.propai.js";
import {
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: PropAiSyncConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, both loadConfig() and loadPropAiSyncPlugins() already cache
