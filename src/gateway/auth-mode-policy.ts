...
export function hasAmbiguousGatewayAuthModeConfig(cfg: PropAiSyncConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: PropAiSyncConfig): void {
