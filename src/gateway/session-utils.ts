...
import { type PropAiSyncConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PropAiSyncConfig): string[] {
...
export function listAgentsForGateway(cfg: PropAiSyncConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PropAiSyncConfig): string {
...
function resolveSessionStoreAgentId(cfg: PropAiSyncConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: PropAiSyncConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: PropAiSyncConfig): GatewaySessionsDefaults {
