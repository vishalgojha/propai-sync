...
function resolveDefaultAccountId(cfg: PropAiSyncConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PropAiSyncConfig): boolean {
...
export function summarizeBindings(cfg: PropAiSyncConfig, bindings: AgentBinding[]): string[] {
