...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set PROPAI_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `PropAi Sync dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control PropAiSync.");
  } else if (hint) {
    runtime.log(hint);
  }
}
