...
export function applyVercelAiGatewayProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
...
export function applyVercelAiGatewayConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
