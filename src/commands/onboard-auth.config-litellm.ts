...
export function applyLitellmProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
...
export function applyLitellmConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
