...
export function applyOpenrouterProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotProviderConfigCn(cfg: PropAiSyncConfig): PropAiSyncConfig {
...
export function applyMoonshotConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
...
export function applyQianfanProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
...
export function applyModelStudioProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: PropAiSyncConfig): PropAiSyncConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
  const next = applyModelStudioProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MODELSTUDIO_DEFAULT_MODEL_REF);
}

export function applyModelStudioConfigCn(cfg: PropAiSyncConfig): PropAiSyncConfig {
