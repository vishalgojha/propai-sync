...
export async function loadValidConfigOrThrow(): Promise<PropAiSyncConfig> {
...
export async function updateConfig(
  mutator: (cfg: PropAiSyncConfig) => PropAiSyncConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: PropAiSyncConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: PropAiSyncConfig): Set<string> {
