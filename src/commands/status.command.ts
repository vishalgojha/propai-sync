...
export async function statusCommand(
  ...
  const daemonValue = (() => {
    ...
    const installedPrefix = daemon.managedByPropAiSync ? "installed · " : "";
  ...
  const nodeDaemonValue = (() => {
    ...
    const installedPrefix = nodeDaemon.managedByPropAiSync ? "installed · " : "";
  ...
  runtime.log(theme.heading("PropAi Sync status"));
  runtime.log("");
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.propai.ai/faq");
  runtime.log("Troubleshooting: https://docs.propai.ai/troubleshooting");
  runtime.log("");
