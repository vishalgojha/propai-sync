...
export function applyMinimaxProviderConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
...
export function applyMinimaxConfig(cfg: PropAiSyncConfig): PropAiSyncConfig {
