...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.propai_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.propai_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.propai_SERVICE_MARKER = originalServiceMarker;
    }
  });
