...
export function isCommandEnabled(cfg: PropAiSyncConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: PropAiSyncConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: PropAiSyncConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: PropAiSyncConfig) {
