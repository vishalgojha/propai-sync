...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "PropAiSync.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by PropAi Sync out-of-band. Treat it as authoritative metadata about the current message context.",
