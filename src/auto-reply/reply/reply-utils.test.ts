...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bPropAiSync\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "PropAi Sync" },
        expected: "[PropAi Sync]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "PropAi Sync",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[PropAi Sync] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
