...
function resolveAcpStreamCoalesceIdleMs(cfg: PropAiSyncConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: PropAiSyncConfig): number {
...
export function resolveAcpProjectionSettings(cfg: PropAiSyncConfig): AcpProjectionSettings {
