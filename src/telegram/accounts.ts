...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.propai_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: PropAiSyncConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PropAiSyncConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/propai/propai/issues/30673
...
export function listEnabledTelegramAccounts(cfg: PropAiSyncConfig): ResolvedTelegramAccount[] {
