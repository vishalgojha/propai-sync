...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PropAiSyncConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PropAiSyncConfig; env: NodeJS.ProcessEnv }): {
  cfg: PropAiSyncConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
