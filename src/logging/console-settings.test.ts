...
let originalPropAiSyncTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalPropAiSyncTestConsole = process.env.propai_TEST_CONSOLE;
  process.env.propai_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalPropAiSyncTestConsole === undefined) {
    delete process.env.propai_TEST_CONSOLE;
  } else {
    process.env.propai_TEST_CONSOLE = originalPropAiSyncTestConsole;
  }
