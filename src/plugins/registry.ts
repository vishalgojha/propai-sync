...
import type {
  PropAiSyncPluginApi,
  PropAiSyncPluginChannelRegistration,
  PropAiSyncPluginCliRegistrar,
  PropAiSyncPluginCommandDefinition,
  PropAiSyncPluginHttpRouteAuth,
  PropAiSyncPluginHttpRouteMatch,
  PropAiSyncPluginHttpRouteHandler,
  PropAiSyncPluginHttpRouteParams,
  PropAiSyncPluginHookOptions,
  ProviderPlugin,
  PropAiSyncPluginService,
  PropAiSyncPluginToolContext,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: PropAiSyncPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: PropAiSyncPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: PropAiSyncPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: PropAiSyncPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: PropAiSyncPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: PropAiSyncPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: PropAiSyncPluginHookOptions | undefined,
    config: PropAiSyncPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: PropAiSyncPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: PropAiSyncPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as PropAiSyncPluginChannelRegistration).plugin === "object"
        ? (registration as PropAiSyncPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: PropAiSyncPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: PropAiSyncPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: PropAiSyncPluginCommandDefinition) => {
