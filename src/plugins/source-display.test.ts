...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/propai/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/propai/extensions",
        global: "/Users/x/.propai/extensions",
        workspace: "/Users/x/ws/.propai/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.propai/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/propai/extensions",
        global: "/Users/x/.propai/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.propai/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/propai/extensions",
        global: "/Users/x/.propai/extensions",
