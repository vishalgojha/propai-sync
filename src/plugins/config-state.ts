...
export const normalizePluginsConfig = (
  config?: PropAiSyncConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: PropAiSyncConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: PropAiSyncConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: PropAiSyncConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
