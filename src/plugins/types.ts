...
export type PropAiSyncPluginConfigSchema = {
...
export type PropAiSyncPluginToolContext = {
...
export type PropAiSyncPluginToolFactory = (
  ctx: PropAiSyncPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type PropAiSyncPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type PropAiSyncPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type PropAiSyncPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current PropAi Sync configuration */
  config: PropAiSyncConfig;
 ...
 */
export type PropAiSyncPluginCommandDefinition = {
...
export type PropAiSyncPluginHttpRouteAuth = "gateway" | "plugin";
export type PropAiSyncPluginHttpRouteMatch = "exact" | "prefix";

export type PropAiSyncPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type PropAiSyncPluginHttpRouteParams = {
  path: string;
  handler: PropAiSyncPluginHttpRouteHandler;
  auth: PropAiSyncPluginHttpRouteAuth;
  match?: PropAiSyncPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type PropAiSyncPluginCliContext = {
  program: Command;
  config: PropAiSyncConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type PropAiSyncPluginCliRegistrar = (ctx: PropAiSyncPluginCliContext) => void | Promise<void>;

export type PropAiSyncPluginServiceContext = {
  config: PropAiSyncConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type PropAiSyncPluginService = {
  id: string;
  start: (ctx: PropAiSyncPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: PropAiSyncPluginServiceContext) => void | Promise<void>;
};

export type PropAiSyncPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type PropAiSyncPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: PropAiSyncPluginConfigSchema;
  register?: (api: PropAiSyncPluginApi) => void | Promise<void>;
  activate?: (api: PropAiSyncPluginApi) => void | Promise<void>;
};

export type PropAiSyncPluginModule =
  | PropAiSyncPluginDefinition
  | ((api: PropAiSyncPluginApi) => void | Promise<void>);

export type PropAiSyncPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | PropAiSyncPluginToolFactory,
    opts?: PropAiSyncPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: PropAiSyncPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: PropAiSyncPluginHttpRouteParams) => void;
  registerChannel: (registration: PropAiSyncPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: PropAiSyncPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: PropAiSyncPluginService) => void;
   ...
   */
  registerCommand: (command: PropAiSyncPluginCommandDefinition) => void;
