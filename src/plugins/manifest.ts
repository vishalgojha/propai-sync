...
export const PLUGIN_MANIFEST_FILENAME = "PropAiSync.plugin.json";
...
// package.json "PropAi Sync" metadata (used for onboarding/catalog)
...
export type PropAiSyncPackageManifest = {
  extensions?: string[];
...
): PropAiSyncPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
