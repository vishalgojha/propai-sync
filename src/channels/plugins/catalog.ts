...
import { discoverPropAiSyncPlugins } from "../../plugins/discovery.js";
import type { PropAiSyncPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, PropAiSyncPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["PROPAI_PLUGIN_CATALOG_PATHS", "PROPAI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<PropAiSyncPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: PropAiSyncPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: PropAiSyncPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverPropAiSyncPlugins({ workspaceDir: options.workspaceDir });
