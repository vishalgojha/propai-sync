...
export function listChannelMessageActions(cfg: PropAiSyncConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: PropAiSyncConfig): boolean {
...
export function supportsChannelMessageCards(cfg: PropAiSyncConfig): boolean {
