...
export type ChannelAgentToolFactory = (params: { cfg?: PropAiSyncConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PropAiSyncConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: PropAiSyncConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PropAiSyncConfig }) => boolean;
  supportsCards?: (params: { cfg: PropAiSyncConfig }) => boolean;
