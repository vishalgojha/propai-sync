...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: PropAiSyncConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: PropAiSyncConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: PropAiSyncConfig) => string;
  setAccountEnabled?: (params: {
    cfg: PropAiSyncConfig;
    accountId: string;
    enabled: boolean;
  }) => PropAiSyncConfig;
  deleteAccount?: (params: { cfg: PropAiSyncConfig; accountId: string }) => PropAiSyncConfig;
  isEnabled?: (account: ResolvedAccount, cfg: PropAiSyncConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: PropAiSyncConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: PropAiSyncConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: PropAiSyncConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: PropAiSyncConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.propai.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: PropAiSyncConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
