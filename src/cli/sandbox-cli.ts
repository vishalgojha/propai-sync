...
const SANDBOX_EXAMPLES = {
  main: [
    ["propai sandbox list", "List all sandbox containers."],
    ["propai sandbox list --browser", "List only browser containers."],
    ["propai sandbox recreate --all", "Recreate all containers."],
    ["propai sandbox recreate --session main", "Recreate a specific session."],
    ["propai sandbox recreate --agent mybot", "Recreate agent containers."],
    ["propai sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["propai sandbox list", "List all sandbox containers."],
    ["propai sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["propai sandbox recreate --all", "Recreate all containers."],
    ["propai sandbox recreate --session main", "Recreate a specific session."],
    ["propai sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["propai sandbox recreate --browser --all", "Recreate only browser containers."],
    ["propai sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["propai sandbox explain", "Show effective sandbox config."],
    ["propai sandbox explain --session agent:main:main", "Explain a specific session."],
    ["propai sandbox explain --agent work", "Explain an agent sandbox."],
    ["propai sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.propai.ai/cli/sandbox")}\n`,
    )
    .action(() => {
