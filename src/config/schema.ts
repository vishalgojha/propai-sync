...
export type ConfigSchema = ReturnType<typeof PropAiSyncSchema.toJSONSchema>;
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const hints = applyDerivedTags(mapSensitivePaths(PropAiSyncSchema, "", buildBaseHints()));
  const next = {
