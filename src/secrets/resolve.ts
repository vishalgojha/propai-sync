...
function resolveResolutionLimits(config: PropAiSyncConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: PropAiSyncConfig): SecretProviderConfig {
