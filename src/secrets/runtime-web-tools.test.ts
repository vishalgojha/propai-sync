...
async function runRuntimeWebTools(params: { config: PropAiSyncConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: PropAiSyncConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
