...
export function listAuthProfileStorePaths(config: PropAiSyncConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: PropAiSyncConfig, stateDir: string): string[] {
