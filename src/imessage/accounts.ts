...
function mergeIMessageAccountConfig(cfg: PropAiSyncConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: PropAiSyncConfig): ResolvedIMessageAccount[] {
