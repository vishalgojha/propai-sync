...
export const A2UI_PATH = "/__PROPAI__/a2ui";

export const CANVAS_HOST_PATH = "/__PROPAI__/canvas";

export const CANVAS_WS_PATH = "/__PROPAI__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.propaiCanvasA2UIAction.postMessage(...)
  // - Android: window.propaiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["PropAiSyncCanvasA2UIAction"];
  ...
  globalThis.propai = globalThis.propai ?? {};
  globalThis.propai.postMessage = postToNode;
  globalThis.propai.sendUserAction = sendUserAction;
  globalThis.propaiPostMessage = postToNode;
  globalThis.propaiSendUserAction = sendUserAction;
