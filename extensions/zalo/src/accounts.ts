...
import { createAccountListHelpers, type PropAiSyncConfig } from "propai/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: PropAiSyncConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: PropAiSyncConfig): ResolvedZaloAccount[] {
