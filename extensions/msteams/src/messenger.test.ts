...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "propai/plugin-sdk/msteams";
...
import { resolvePreferredPropAiSyncTmpDir } from "../../../src/infra/tmp-propai-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredPropAiSyncTmpDir(), "msteams-mention-"));
