...
import { isSecretRef } from "propai/plugin-sdk/googlechat";
import { createAccountListHelpers, type PropAiSyncConfig } from "propai/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: PropAiSyncConfig): ResolvedGoogleChatAccount[] {
