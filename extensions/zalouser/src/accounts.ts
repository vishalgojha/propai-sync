...
import { createAccountListHelpers, type PropAiSyncConfig } from "propai/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: PropAiSyncConfig, accountId: string): ZalouserAccountConfig {
