...
import type { ReplyPayload, PropAiSyncConfig } from "propai/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "propai/plugin-sdk/twitch";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // PropAiSyncConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as PropAiSyncConfig;
