/**
 * Twitch channel plugin for PropAiSync.
 *
 * Main plugin export combining all adapters (outbound, actions, status, gateway).
 * This is the primary entry point for the Twitch channel integration.
 */

import type { PropAiSyncConfig } from "propai/plugin-sdk/twitch";
import { buildChannelConfigSchema } from "propai/plugin-sdk/twitch";
 ...
 * for PropAiSync. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: PropAiSyncConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: PropAiSyncConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: PropAiSyncConfig): boolean => {
