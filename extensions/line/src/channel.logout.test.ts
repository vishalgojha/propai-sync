import type { PropAiSyncConfig, PluginRuntime, ResolvedLineAccount } from "propai/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: PropAiSyncConfig; accountId: string }): Promise<{
