...
export const tlonPlugin: ChannelPlugin = {
  ...
  status: {
    ...
    buildAccountSnapshot: ({ account, runtime, probe }) => {
      ...
      return snapshot as import("propai/plugin-sdk/tlon").ChannelAccountSnapshot;
    },
  },
  gateway: {
    startAccount: async (ctx) => {
      ...
      ctx.setStatus({
        ...
        ship: account.ship,
        url: account.url,
      } as import("propai/plugin-sdk/tlon").ChannelAccountSnapshot);
