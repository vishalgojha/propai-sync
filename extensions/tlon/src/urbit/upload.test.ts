...
vi.mock("propai/plugin-sdk/tlon", async (importOriginal) => {
  const actual = await importOriginal<typeof import("propai/plugin-sdk/tlon")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  ...
  it("fetches image and calls uploadFile, returns uploaded URL", async () => {
    const { fetchWithSsrFGuard } = await import("propai/plugin-sdk/tlon");
