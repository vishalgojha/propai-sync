...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "propai/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: PropAiSyncPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: PropAiSyncPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
