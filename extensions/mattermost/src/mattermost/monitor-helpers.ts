...
export { createDedupeCache, rawDataToString } from "propai/plugin-sdk/mattermost";
...
function listAgents(cfg: PropAiSyncConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: PropAiSyncConfig, agentId: string): string | undefined {
