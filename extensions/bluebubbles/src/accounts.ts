...
import { createAccountListHelpers, type PropAiSyncConfig } from "propai/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: PropAiSyncConfig): ResolvedBlueBubblesAccount[] {
