...
import { resolveChannelMediaMaxBytes, type PropAiSyncConfig } from "propai/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: PropAiSyncConfig; accountId?: string }): string[] {
