...
Nostr DM channel plugin for PropAi Sync using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to PropAi Sync. It enables your bot to:
...
```bash
PropAi Sync plugins install @propai/nostr
```
...
# Configure PropAi Sync to use local relay
