...
enum UIStrings {
    static let welcomeTitle = "Welcome to PropAi Sync"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "PropAiSync.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: PropAiSyncChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g propai@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: PropAiSyncChatViewModel(
