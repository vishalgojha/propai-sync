...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case PropAiSyncBrowserCommand.proxy.rawValue:
            ...
            case PropAiSyncLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case PropAiSyncSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case PropAiSyncSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case PropAiSyncSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case PropAiSyncSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case PropAiSyncSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case PropAiSyncCanvasA2UICommand.push.rawValue,
             PropAiSyncCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard PropAiSyncConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: PropAiSyncNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__PROPAI__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(PropAiSyncSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(PropAiSyncSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: PropAiSyncSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> PropAiSyncLocationMode {
    ...
    private static func errorResponse(
        ...
        code: PropAiSyncNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: PropAiSyncNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: PropAiSyncCanvasSnapshotFormat,
        maxWidth: Int?,
