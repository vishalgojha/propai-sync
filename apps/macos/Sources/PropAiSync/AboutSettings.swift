...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/propai/propai") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/propai/propai")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://propai.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "PropAiSyncBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PropAiSyncBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "PropAiSyncGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PropAiSyncGitCommit") as? String) ??
            "unknown"
    }
