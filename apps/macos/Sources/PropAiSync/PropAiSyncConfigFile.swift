...
enum PropAiSyncConfigFile {
    private static let logger = Logger(subsystem: "ai.propai", category: "config")
    ...
    static func stateDirURL() -> URL {
        PropAiSyncPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        PropAiSyncPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-propai-config-file",
            "event": "config.write",
