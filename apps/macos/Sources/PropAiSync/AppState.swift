...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PropAiSyncConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PropAiSyncConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: PropAiSyncConfigFile.loadDict(),
        ...
        PropAiSyncConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/PropAiSync"
        state.remoteCliPath = ""
        return state
    }
}
