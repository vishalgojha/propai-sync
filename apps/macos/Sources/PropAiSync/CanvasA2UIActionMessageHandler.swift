...
final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    ...
    func userContentController(_: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        let text = PropAiSyncCanvasA2UIAction.formatAgentMessage(messageContext)
        ...
        Task { [weak webView] in
            ...
            await MainActor.run {
                ...
                let js = PropAiSyncCanvasA2UIAction.jsDispatchA2UIActionStatus(
                    actionId: actionId,
                    ok: result.ok,
                    error: result.error)
    ...
    // Formatting helpers live in PropAiSyncKit (`PropAiSyncCanvasA2UIAction`).
}
