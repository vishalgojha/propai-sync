...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .propaiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? PropAiSyncPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? PropAiSyncPaths.stateDirURL.path
...
extension Notification.Name {
    static let PropAiSyncSelectSettingsTab = Notification.Name("PropAiSyncSelectSettingsTab")
}
