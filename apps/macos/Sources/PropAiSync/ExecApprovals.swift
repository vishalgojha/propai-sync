...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.propai", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        PropAiSyncPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PropAiSyncPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
