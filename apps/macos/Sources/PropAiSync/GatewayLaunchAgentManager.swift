...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.propai", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".propai/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.propaiCommand(
            subcommand: "gateway",
