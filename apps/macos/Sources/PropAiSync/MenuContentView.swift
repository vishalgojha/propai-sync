...
/// Menu contents for the PropAi Sync menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About PropAi Sync") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "PropAi Sync Not Configured"
        case .remote:
            "Remote PropAi Sync Active"
        case .local:
            "PropAi Sync Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .propaiSelectSettingsTab, object: tab)
        }
    }
