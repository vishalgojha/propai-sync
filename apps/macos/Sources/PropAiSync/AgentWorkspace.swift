...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.propai", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PropAiSyncConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - PropAi Sync Workspace
