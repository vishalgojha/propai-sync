...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.propai", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.propai", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PropAiSyncChatMessage] = messages.compactMap { item in
