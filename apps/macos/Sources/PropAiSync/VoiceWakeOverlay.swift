...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.propai", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other PropAi Sync windows, but below the system’s pop-up menus.
