...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: PropAiSyncProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": PropAiSyncProtocol.AnyCodable("start"),
                "name": PropAiSyncProtocol.AnyCodable("bash"),
            ],
            summary: nil)
