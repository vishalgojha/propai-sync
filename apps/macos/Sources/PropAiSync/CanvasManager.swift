...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.propai", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("propai/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__PROPAI__/a2ui/").absoluteString + "?platform=macos"
    }
