...
import ai.propai.app.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "PropAi Sync",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("PropAi Sync is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
