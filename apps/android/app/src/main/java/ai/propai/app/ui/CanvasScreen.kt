  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("PropAiSyncWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            override fun onReceivedError(
              ...
              Log.e("PropAiSyncWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              if (isDebuggable) {
                Log.d("PropAiSyncWebView", "onPageFinished: $url")
              }
...
private class CanvasA2UIActionBridge(private val onMessage: (String) -> Unit) {
  ...
  companion object {
    const val interfaceName: String = "PropAiSyncCanvasA2UIAction"
  }
}
