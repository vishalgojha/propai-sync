...
import ai.propai.app.ui.mobileSurface
import ai.propai.app.ui.mobileText
import ai.propai.app.ui.mobileTextSecondary
import ai.propai.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.propai.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.propai.app.ui.mobileFontFamily,
