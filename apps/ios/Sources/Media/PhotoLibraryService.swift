...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: PropAiSyncPhotosLatestParams) async throws -> PropAiSyncPhotosLatestPayload {
        ...
        var results: [PropAiSyncPhotoPayload] = []
        ...
        return PropAiSyncPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> PropAiSyncPhotoPayload
    {
