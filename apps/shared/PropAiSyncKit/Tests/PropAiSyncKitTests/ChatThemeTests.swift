...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PropAiSyncChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PropAiSyncChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
