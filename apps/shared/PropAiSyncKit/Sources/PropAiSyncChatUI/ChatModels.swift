...
public typealias PropAiSyncPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PropAiSyncPlatformImage = UIImage
#endif

public struct PropAiSyncChatUsageCost: Codable, Hashable, Sendable {
...
public struct PropAiSyncChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PropAiSyncChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PropAiSyncChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PropAiSyncChatMessageContent: Codable, Hashable, Sendable {
...
public struct PropAiSyncChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PropAiSyncChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PropAiSyncChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PropAiSyncChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PropAiSyncChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PropAiSyncChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PropAiSyncChatMessageContent].self, forKey: .content) {
...
public struct PropAiSyncChatHistoryPayload: Codable, Sendable {
...
public struct PropAiSyncSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PropAiSyncSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PropAiSyncSessionPreviewItem]
}

public struct PropAiSyncSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PropAiSyncSessionPreviewEntry]

    public init(ts: Int, previews: [PropAiSyncSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PropAiSyncChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PropAiSyncChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PropAiSyncAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PropAiSyncChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PropAiSyncGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PropAiSyncPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PropAiSyncPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: PropAiSyncPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct PropAiSyncChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
