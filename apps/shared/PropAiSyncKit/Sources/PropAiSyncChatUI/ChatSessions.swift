...
public struct PropAiSyncChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct PropAiSyncChatSessionsDefaults: Codable, Sendable {
    public let model: String?
    public let contextTokens: Int?
}

public struct PropAiSyncChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct PropAiSyncChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: PropAiSyncChatSessionsDefaults?
    public let sessions: [PropAiSyncChatSessionEntry]
}
