...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: PropAiSyncProtocol.AnyCodable]?
    {
        ...
        return [
            "id": PropAiSyncProtocol.AnyCodable(identity.deviceId),
            "publicKey": PropAiSyncProtocol.AnyCodable(publicKey),
            "signature": PropAiSyncProtocol.AnyCodable(signature),
            "signedAt": PropAiSyncProtocol.AnyCodable(signedAtMs),
            "nonce": PropAiSyncProtocol.AnyCodable(nonce),
        ]
    }
}
