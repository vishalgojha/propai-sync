...
public enum PropAiSyncCanvasA2UICommand: String, Codable, Sendable {
...
public struct PropAiSyncCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PropAiSyncCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
