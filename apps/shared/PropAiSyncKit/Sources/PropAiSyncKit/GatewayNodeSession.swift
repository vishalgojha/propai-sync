...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.propai", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.propai", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: PropAiSyncProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
