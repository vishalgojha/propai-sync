...
public enum PropAiSyncTalkCommand: String, Codable, Sendable {
...
public struct PropAiSyncTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct PropAiSyncTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
